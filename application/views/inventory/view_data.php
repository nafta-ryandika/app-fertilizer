        ...
        ?>
            <tr>
                ...
                <td style="text-align: center !important;">
                    ...
                    <a class="btn btn-danger m-1" id="btnDelete" title="Delete" onclick="remove('data','<?= $data_inventory['id'] . '|' . $data_inventory['inventory_id']; ?>')"><i class="fas fa-fw fa-solid fa-square-xmark m-1"></i></a>
