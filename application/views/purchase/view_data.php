        ...
        ?>
            <tr>
                ...
                <td style="text-align: center !important;">
                    ...
                    <a class="btn btn-primary m-1" id="btnPrint" title="Delete" onclick="report('print','<?= $data_purchase['id'] . '|' . $data_purchase['purchase_id']; ?>')"><i class="fas fa-fw fa-solid fa-print m-1"></i></a>
                </td>
            </tr>
        <?php
            $i++;
